                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="" value="{{ !empty(old('title')) ? old('title') : $page->title }}">
                        </div>
                        <div class="form-group">
                            <label for="symbol">{{ __('view.users.label.symbol') }}</label>
                            <input type="text" class="form-control" id="symbol" name="symbol" placeholder="" value="{{ !empty(old('symbol')) ? old('symbol') : $page->symbol }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control select2-no-search" name="language_id" id="language_id" style="width: 100%;">
                                @foreach($languages as $id => $language)
                                    @if((!empty(old('language_id')) && old('language_id') == $id) || (empty(old('language_id')) && $page->language_id ==  $id))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2-no-search" name="published" id="published" style="width: 100%;">
                                @if((!empty(old('published')) && old('published') == 0) || (empty(old('published')) && $page->published == 0))
                                    <option value="0" selected>{{ __('view.no') }}</option>
                                @else
                                    <option value="0">{{ __('view.no') }}</option>
                                @endif
                                @if((!empty(old('published')) && old('published') == 1) || (empty(old('published')) && $page->published == 1))
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="jq-summernote-200" name="lead" id="lead">{{ !empty(old('lead')) ? old('lead') : $page->lead }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description">{{ __('view.users.label.description') }}</label>
                            <textarea class="jq-summernote-500" name="description" id="description">{{ !empty(old('description')) ? old('description') : $page->description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="meta_title" name="meta_title" placeholder="" value="{{ !empty(old('meta_title')) ? old('meta_title') : $page->meta_title }}">
                        </div>
                        <div class="form-group">
                            <label for="meta_words">{{ __('view.meta.label.words') }}</label>
                            <input type="text" class="form-control" id="meta_words" name="meta_words" placeholder="" value="{{ !empty(old('meta_words')) ? old('meta_words') : $page->meta_words }}">
                        </div>
                        <div class="form-group">
                            <label for="lead">{{ __('view.meta.label.description') }}</label>
                            <textarea class="form-control" name="meta_description" id="meta_description">{{ !empty(old('meta_description')) ? old('meta_description') : $page->meta_description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="created_at" placeholder="" value="{{ $page->created_at }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="modified_at">{{ __('view.users.label.updated_at') }}</label>
                            <input type="text" class="form-control" id="updated_at" placeholder="" value="{{ $page->updated_at }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
